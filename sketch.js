...
//move the code of velocity indide framecount
  ...
  if (frameCount % 90 === 0) {
    ...
    obstacle.y = Math.round(random(200,280));
    obstacle.addImage(obstacle_img);
    obstacle.scale = 0.124;
...
function spawnObstacles2() {
  ...
  //add the obstacleGroup2if (frameCount % 60 === 0) {
   
    
   
    if (frameCount % 80 === 0) {
      var obstacle2= createSprite(600,250,40,10);
      obstacle2.y = random(100,150);    
